...
public:
  LowPassFilter()
      : fs_(0), fc_(0.0), d_(0.0), b_{0.0, 0.0, 0.0}, a_{0.0, 0.0, 0.0},
        prev_x_{0.0f, 0.0f, 0.0f}, prev_y_{0.0f, 0.0f, 0.0f} {}
...
public:
  ...
  static std::array<float, WAVE_SIZE> *getWaveTable(WAVE_FORMS wave,
                                                    pitch_t freq);
