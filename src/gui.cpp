...
void GUI::drawOutput (float* output)
{
    ...
    ImGui::SetNextWindowPos ({ ImGui::GetMainViewport()->Size.x - (ICON_SIZE * RENDER_SCALE * 4),
...
void GUI::drawToolbar()
{
    ImGui::SetNextWindowPos (
        { 0, ImGui::GetMainViewport()->GetCenter().y - (ICON_SIZE * RENDER_SCALE / 2) });
    ...
    if (ImGui::ColorButton ("Generator Block",
                            toImVec4 (GENERATOR_COLOR),
                            0,
                            { ICON_SIZE * RENDER_SCALE, ICON_SIZE * RENDER_SCALE }))
    ...
    if (ImGui::ColorButton ("Sequencer",
                            toImVec4 (SEQUENCER_COLOR),
                            0,
                            { ICON_SIZE * RENDER_SCALE, ICON_SIZE * RENDER_SCALE }))
    ...
    ImGui::SetNextWindowPos ({ ImGui::GetMainViewport()->GetCenter().x,
                               ImGui::GetMainViewport()->Size.y - ICON_SIZE * RENDER_SCALE });
