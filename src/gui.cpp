...
void GUI::drawOutput(float* output)
{
	...
	ImGui::PlotLines("##", output, BUFFER_SIZE, 0, nullptr, -1.0f, 1.0f,
...
void GUI::drawToolbar()
{
	...
	ImGui::SetNextWindowSize({
		...
		ICON_SIZE * RENDER_SCALE / 2 + ICON_SIZE * RENDER_SCALE * 3
	}); // TODO: find better way to adjust margins of button border
	...
	ImGui::SetNextWindowPos({
		ImGui::GetMainViewport()->GetCenter().x, ImGui::GetMainViewport()->Size.y - ICON_SIZE * RENDER_SCALE
	});
